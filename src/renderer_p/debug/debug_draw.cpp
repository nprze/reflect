...
rfct::debugDraw::debugDraw():m_Buffer(RFCT_DEBUG_DRAW_VERTEX_BUFFER_MAX_TRIANGLE_COUNT * sizeof(debugTriangle), vk::BufferUsageFlagBits::eVertexBuffer, VMA_MEMORY_USAGE_CPU_TO_GPU),
...
void rfct::debugDraw::draw(frameData& fd)
{
	if (m_TriangleCount == 0)
	{
		return;
	}
    vk::CommandBuffer commandBuffer = fd.getCommandBuffer();
