...
namespace rfct {
	...
	public:
		...
		void draw(const RfctFrameContext& ctx, RfctSwapChain& swapChain, frameSyncDataTemp& fd, vk::Framebuffer framebuffer, vk::RenderPass renderPass);
		...
		void beginAddingTriangles(RfctSwapChain& swapChain);
