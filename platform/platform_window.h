...
#define RFCT_VULKAN_LOADER_NAMESPACE vk::detail
#define RFCT_RENDERER_ARGUMENTS RFCT_NATIVE_WINDOW_ANDROID RFCT_NATIVE_WINDOW_ANDROID_VAR
#define RFCT_RENDERER_ARGUMENTS_VAR RFCT_NATIVE_WINDOW_ANDROID_VAR
#else
...
#define RFCT_WINDOWS_WINDOW_ARGUMENTS "reflect"
#define RFCT_VULKAN_LOADER_NAMESPACE vk
#define RFCT_RENDERER_ARGUMENTS
#define RFCT_RENDERER_ARGUMENTS_VAR 
#endif // ANDROID_BUILD
